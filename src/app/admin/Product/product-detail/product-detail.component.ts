  ...
  updateProduct() {
    ...
    if (this.productService.productForm.valid) {
      let productInfo = new Product(
        this.productService.productForm.value.$Id,
        ...
        new ProductDetail(
          ...
          // this.productService.productForm.get('productDetail.id')?.value,
          this.productService.productForm.value.$Id,
          ...
          undefined,
          this.productService.productForm.value.$Id,
          // this.productService.productForm.get('productDetail.productid')?.value,
          undefined
        ),
        undefined,
        undefined
      ...
      this.productService.UpdateProduct(productInfo).subscribe(res => {
        if (res.isSuccess) {
